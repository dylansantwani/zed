...
impl NewPathPrompt {
    pub(crate) fn register(workspace: &mut Workspace, _cx: &mut ModelContext<Workspace>) {
...
impl PickerDelegate for NewPathDelegate {
    ...
    fn set_selected_index(&mut self, ix: usize, cx: &mut ModelContext<picker::Picker<Self>>) {
    ...
    fn confirm_update_query(&mut self, cx: &mut ModelContext<Picker<Self>>) -> Option<String> {
    ...
    fn confirm(&mut self, _: bool, cx: &mut ModelContext<picker::Picker<Self>>) {
